...
router.get('/', function (req, res) {
    ...
    if (names) {
        res.send((0, skills_1.default)(String(names), undefined, undefined, undefined, undefined, (0, utils_1.getBoolean)(String(includeNames))));
    }
    else {
        res.send((0, skills_1.default)(String(languages), String(frameworks), String(libraries), String(tools), String(software), (0, utils_1.getBoolean)(String(includeNames))));
    }
