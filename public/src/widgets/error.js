...
function errorWidget(widgetName, nameX, reason, reasonX) {
    ...
    <g id="error-card" transform="translate(-187 -87)">
        ...
        <text id="error-text" data-name="error-text" transform="translate(310 269)" fill="#ff4951" font-size="42" font-family="Roboto-Medium, Roboto" font-weight="500">
