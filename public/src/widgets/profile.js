            ...
            switch (dataOptions[i].toLowerCase()) {
                case 'followers':
                    dataBoxes += `<g id="followers" transform="translate(${(dataOptions.length - 1 - i) * -108} 0)">
                        ...
                        <text id="followers-text" data-name="followers-text" transform="translate(-47 25)" fill="#00C6FF" font-size="16" font-family="Roboto-Regular, Roboto, sans-serif">
                            <tspan x="0" y="0">${profile.data.user.followers.totalCount}</tspan>
                        </text>
                ...
                case 'repositories':
                    dataBoxes += `<g id="repositories" transform="translate(${(dataOptions.length - 1 - i) * -108} 0)">
                            ...
                            <text id="repostiories-text" data-name="repositories-text" transform="translate(-47 25)" fill="#FF0774" font-size="16" font-family="Roboto-Regular, Roboto, sans-serif">
                                <tspan x="0" y="0">${profile.data.user.repositories.totalCount}</tspan>
                            </text>
                ...
                case 'stars':
                    dataBoxes += `<g id="stars" transform="translate(${(dataOptions.length - 1 - i) * -108} 0)">
                        ...
                        <text id="stars-text" data-name="stars-text" transform="translate(-47 25)" fill="#FFA100" font-size="16" font-family="Roboto-Regular, Roboto, sans-serif">
                            <tspan x="0" y="0">${stargazers.reduce((a, b) => a + b, 0)}</tspan>
                        </text>
                ...
                case 'commits':
                    dataBoxes += `<g id="contributions" transform="translate(${(dataOptions.length - 1 - i) * -108} 0)">
                        ...
                        <text id="contributions-text" data-name="contributions-text" transform="translate(-47 25)" fill="#00F14F" font-size="16" font-family="Roboto-Regular, Roboto, sans-serif">
                            <tspan x="0" y="0">${profile.data.user.contributionsCollection
                        .contributionCalendar.totalContributions}</tspan>
                        </text>
    ...
    try {
        ...
        return `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}">
                                    ...
                                    <g id="profile-card">
                                        ...
                                        <text id="text-name" data-name="text-name" transform="translate(145 78)" font-size="26" font-family="Roboto-Medium, Roboto, sans-serif" font-weight="500"><tspan x="0" y="0">${response.data.name === null ? response.data.login : response.data.name}</tspan></text>
