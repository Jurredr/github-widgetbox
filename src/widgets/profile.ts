    ...
    function getDataOptions() {
        ...
        for (let i = 0; i < dataOptions.length; i++) {
            switch (dataOptions[i].toLowerCase()) {
                case 'followers':
                    dataBoxes += `<g id="followers" transform="translate(${(dataOptions.length - 1) * 108} 0)">
                        <rect id="followers-box" width="90" height="37" rx="18.5" transform="translate(-90 0)" fill="#CAF0FF"/>
                        <text id="followers-text" data-name="followers-text" transform="translate(-90 0)" fill="#00C6FF" font-size="16" font-family="Roboto-Regular, Roboto, sans-serif"><tspan x="0" y="0">100</tspan></text>
                        <path id="followers-icon" transform="translate(-90 0)" fill="#00C6FF" d="M3.625,9.5A2.417,2.417,0,1,0,1.208,7.084,2.419,2.419,0,0,0,3.625,9.5Zm16.919,0a2.417,2.417,0,1,0-2.417-2.417A2.419,2.419,0,0,0,20.544,9.5Zm1.208,1.208H19.336a2.41,2.41,0,0,0-1.7.7,5.524,5.524,0,0,1,2.836,4.132h2.493a1.207,1.207,0,0,0,1.208-1.208V13.126A2.419,2.419,0,0,0,21.753,10.709Zm-9.668,0a4.23,4.23,0,1,0-4.23-4.23A4.228,4.228,0,0,0,12.085,10.709Zm2.9,1.208h-.313a5.84,5.84,0,0,1-5.174,0H9.185a4.352,4.352,0,0,0-4.351,4.351v1.088a1.813,1.813,0,0,0,1.813,1.813H17.523a1.813,1.813,0,0,0,1.813-1.813V16.269A4.352,4.352,0,0,0,14.985,11.918Zm-8.448-.506a2.41,2.41,0,0,0-1.7-.7H2.417A2.419,2.419,0,0,0,0,13.126v1.208a1.207,1.207,0,0,0,1.208,1.208H3.7A5.538,5.538,0,0,1,6.537,11.412Z"/>
                    </g>`
                    break
                case 'repositories':
                    dataBoxes += `<g id="repositories" transform="translate(${(dataOptions.length - 1) * 108} 0)">
                        <rect id="repositories-box" width="90" height="37" rx="18.5" transform="translate(358 395)" fill="#FFCEE4"/>
                        <text id="repostiories-text" data-name="repositories-text" transform="translate(401.2 420)" fill="#FF0774" font-size="16" font-family="Roboto-Regular, Roboto, sans-serif"><tspan x="0" y="0">100</tspan></text>
                        <path id="repositories-icon" d="M7.106,3A2.106,2.106,0,0,0,5,5.106V17.74a.7.7,0,0,0,.207.5,2.026,2.026,0,0,0,1.9,1.608h.7v-1.4h-.7a.7.7,0,0,1,0-1.4H17.634a1.4,1.4,0,0,0,1.4-1.4V4.4a1.4,1.4,0,0,0-1.4-1.4Zm.7,2.106h.7a.7.7,0,0,1,.7.7v.7a.7.7,0,0,1-.7.7h-.7a.7.7,0,0,1-.7-.7v-.7A.7.7,0,0,1,7.808,5.106Zm0,3.51h.7a.7.7,0,0,1,.7.7v.7a.7.7,0,0,1-.7.7h-.7a.7.7,0,0,1-.7-.7v-.7A.7.7,0,0,1,7.808,8.615Zm0,3.51h.7a.7.7,0,0,1,.7.7v.7a.7.7,0,0,1-.7.7h-.7a.7.7,0,0,1-.7-.7v-.7A.7.7,0,0,1,7.808,12.125Zm1.4,6.317v3.51l2.106-1.4,2.106,1.4v-3.51Zm5.615,0v1.4h3.51a.7.7,0,0,0,0-1.4Z" transform="translate(372.8 402.049)" fill="#FF0774"/>
                    </g>`
                    break
                case 'stars':
                    dataBoxes += `<g id="stars" transform="translate(${(dataOptions.length - 1) * 108} 0)">
                ...
                case 'contributions':
                case 'commits':
                    dataBoxes += `<g id="contributions" transform="translate(${(dataOptions.length - 1) * 108} 0)">
