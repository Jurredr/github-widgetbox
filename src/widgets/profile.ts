                    ...
                    (avatar) => {
                        return `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="842" height="165" viewBox="0 0 842 165">
                                    ...
                                    <g id="profile-card" transform="translate(-1370 -2006)">
                                        ...
                                        <text id="text-url" data-name="text-url" transform="translate(1515 2108)" fill="#bfbfbf" font-size="16" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">GitHub.com/${response.data.login}</tspan></text>
                                        <g id="stars" transform="translate(41 -6)">
                                            ...
                                            <text id="stars-text" data-name="stars-text" transform="translate(2067.486 2098)" fill="#FFA100" font-size="16" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">10</tspan></text>
                                        ...
                                        <g id="followers" transform="translate(1474 1672)">
                                            ...
                                            <text id="followers-text" data-name="followers-text" transform="translate(406.4 420)" fill="#00C6FF" font-size="16" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">100</tspan></text>
                                        ...
                                        <g id="repositories" transform="translate(1588 1672)">
                                            ...
                                            <text id="repostiory-text" data-name="repository-text" transform="translate(401.2 420)" fill="#FF0774" font-size="16" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">100</tspan></text>
                                        ...
                                        <g id="contributions" transform="translate(1620 1702)">
                                            ...
                                            <text id="contributions-text" data-name="contributions-text" transform="translate(401.2 420)" fill="#00F14F" font-size="16" font-family="Roboto-Regular, Roboto"><tspan x="0" y="0">100</tspan></text>
