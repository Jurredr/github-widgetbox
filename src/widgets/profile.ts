    ...
    function getDataOptions() {
        ...
        for (let i = 0; i < dataOptions.length; i++) {
            switch (dataOptions[i].toLowerCase()) {
                case 'followers':
                    dataBoxes += `<g id="followers" transform="translate(0 0)">
                    ...
                    break
                case 'repositories':
                    dataBoxes += `<g id="repositories" transform="translate(0 0)">
                    ...
                    break
                case 'stars':
                    dataBoxes += `<g id="stars" transform="translate(0 0)">
                ...
                case 'contributions':
                case 'commits':
                    dataBoxes += `<g id="contributions" transform="translate(0 0)">
