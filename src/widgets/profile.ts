...
export default async function profileWidget(
    ...
    async function getDataOptions(): Promise<string> {
        ...
        profile.data.user.repositories.nodes.forEach((repo: Repository, index) => {
        ...
        for (let i = 0; i < dataOptions.length; i++) {
            switch (dataOptions[i].toLowerCase()) {
                case 'followers':
                    dataBoxes += `<g id="followers" transform="translate(${
                        (dataOptions.length - 1 - i) * -108
                    } 0)">
                    ...
                    break
                case 'repositories':
                    dataBoxes += `<g id="repositories" transform="translate(${
                        (dataOptions.length - 1 - i) * -108
                    } 0)">
                    ...
                    break
                case 'stars':
                    dataBoxes += `<g id="stars" transform="translate(${
                        (dataOptions.length - 1 - i) * -108
                    } 0)">
                ...
                case 'contributions':
                case 'commits':
                    dataBoxes += `<g id="contributions" transform="translate(${
                        (dataOptions.length - 1 - i) * -108
                    } 0)">
